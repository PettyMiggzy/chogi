...
/*
   ╔════════════════════════════════════════════════════════════════════════╗
   ║  Chogi Lab Subjects · Burn-to-Mint NFT                                ║
   ║                                                                        ║
   ║  Mint by sending $CHOGI to the dead address. NO MON cost.              ║
   ║  5 tiers · soulbound by default (owner can toggle).                    ║
   ║                                                                        ║
   ║  COMMON     · 100,000 $CHOGI                                           ║
   ║  UNCOMMON   · 500,000 $CHOGI                                           ║
   ║  RARE       · 1,000,000 $CHOGI                                         ║
   ║  EPIC       · 5,000,000 $CHOGI                                         ║
   ║  LEGENDARY  · 10,000,000 $CHOGI                                        ║
   ║                                                                        ║
